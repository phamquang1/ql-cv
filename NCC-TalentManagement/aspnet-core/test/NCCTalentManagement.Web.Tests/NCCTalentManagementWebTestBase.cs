...
{
    public abstract class NCCTalentManagementWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static NCCTalentManagementWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(NCCTalentManagementWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<NCCTalentManagementDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<NCCTalentManagementDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<NCCTalentManagementDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<NCCTalentManagementDbContext, Task<T>> func)
        {
            T result;
