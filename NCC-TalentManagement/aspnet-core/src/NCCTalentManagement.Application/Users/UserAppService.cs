...
using NCCTalentManagement.Authorization.Accounts;
...
namespace NCCTalentManagement.Users
{
    ...
    public class UserAppService : AsyncCrudAppService<User, UserDto, long, PagedUserResultRequestDto, CreateUserDto, UserDto>, IUserAppService
    {
        ...
        [HttpPost]
        public async Task<Object> AddUserWithExcel([FromForm] FileInputDto input)
        {
                            ...
                            for (int row = 2; row <= rowCount; row++)
                            {
                                try
                                {
                                    user = new CreateUserDto
                                    {
                                        ...
                                        PositionId = Int32.Parse(worksheet.Cells[row, 7].Value.ToString().Trim()),
                                        BranchId = Int32.Parse(worksheet.Cells[row, 8].Value.ToString().Trim()),
                                        IsActive = true
                                    };
                                    await CreateAsync(user);
                                    successList.Add(user.Name);
                                }
                                catch (Exception e)
                                {
