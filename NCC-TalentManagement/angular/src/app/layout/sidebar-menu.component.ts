...
@Component({
  ...
  styles: ['.active { background-color: red !important ;}']
})
export class SidebarMenuComponent extends AppComponentBase implements OnInit {
  ...
  getMenuItems(): MenuItem[] {
    ...
    //  new MenuItem(this.l('HomePage'), '/app/home', 'fas fa-home'),
      new MenuItem('menu.menu1', '/app/main/my-profile', 'far fa-id-card', 'Page.MyProfile'),
      new MenuItem('menu.menu2', '/app/main/candidate', 'far fa-id-badge', 'Pages.CVCandidate'),
      new MenuItem('menu.menu3', '/app/main/employee', 'fas fa-chalkboard-teacher', 'Pages.CVEmployee'),
